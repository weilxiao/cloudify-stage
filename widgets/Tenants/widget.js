        ...
        value: function render() {
            ...
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(Table.Column, { label: 'Name', name: 'name', width: '40%' }),
                    React.createElement(Table.Column, { label: 'Name', name: 'groups', width: '30%' }),
                    React.createElement(Table.Column, { label: 'Name', name: 'users', width: '30%' }),
                    this.props.data.items.map(function (item) {
                        return React.createElement(
                            Table.Row,
                            { key: item.name, selected: item.isSelected, onClick: _this2._selectTenant.bind(_this2, item.name) },
                            React.createElement(
                                Table.Data,
                                null,
                                item.name
